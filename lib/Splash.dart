...
class _SplashState extends State<Splash> {
  ...
  void initState() {
    super.initState();
    Timer(Duration(seconds: 3),()=>Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>First())));
  }
  @override
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    textAlign: TextAlign.center,
                        ...
                        Padding(
                          padding: const EdgeInsets.fromLTRB(170.0,150.0,0.0,0.0),
                          child: Loader(),
                        ),
                      ],
                    ),
